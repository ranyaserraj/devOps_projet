...
# Fonction pour afficher les métriques d'un conteneur DevOps
display_devops_container_metrics() {
...
display_devops_memory_with_chart() {
    local container_name=$1
    local color=$2
    local label=$3
...
if [[ "$1" == "--continuous" ]]; then
    while true; do
        clear
        echo -e "${CYAN}🚀 DevOps Project - Monitoring Final (DevOps Containers Only)${NC}"
        echo "=================================================================="
        echo ""

        echo -e "${CYAN}💻 CPU Usage - DevOps Project (DevOps Containers Only)${NC}"
        echo "=============================================================="
        display_devops_container_metrics "idurar-portainer" "${GREEN}" "Portainer"
        display_devops_container_metrics "idurar-mongodb" "${YELLOW}" "MongoDB"
        display_devops_container_metrics "idurar-backend" "${BLUE}" "Backend"
        display_devops_container_metrics "idurar-frontend" "${PURPLE}" "Frontend"

        echo -e "${CYAN}🧠 Memory Usage - DevOps Project (DevOps Containers Only)${NC}"
        echo "=================================================================="
        display_devops_memory_with_chart "idurar-portainer" "${GREEN}" "Portainer"
        display_devops_memory_with_chart "idurar-mongodb" "${YELLOW}" "MongoDB"
        display_devops_memory_with_chart "idurar-backend" "${BLUE}" "Backend"
        display_devops_memory_with_chart "idurar-frontend" "${PURPLE}" "Frontend"
        echo ""

        echo -e "${CYAN}📊 DevOps Project Summary (DevOps Containers Only)${NC}"
        echo "=============================================="
        display_devops_cpu_summary "idurar-portainer" "${GREEN}" "Portainer"
        display_devops_cpu_summary "idurar-mongodb" "${YELLOW}" "MongoDB"
        display_devops_cpu_summary "idurar-backend" "${BLUE}" "Backend"
        display_devops_cpu_summary "idurar-frontend" "${PURPLE}" "Frontend"
        echo ""

        echo -e "${CYAN}🎯 Fonctionnalités du dashboard DevOps Containers Only${NC}"
        echo "======================================================"
        echo -e "✅ ${GREEN}Métriques DevOps uniquement${NC} : Seulement les conteneurs DevOps"
        echo -e "✅ ${GREEN}4 conteneurs DevOps spécifiques${NC} : Portainer, MongoDB, Backend, Frontend"
        echo -e "✅ ${GREEN}Métriques individuelles${NC} : Chaque conteneur DevOps a ses propres valeurs"
        ...
        echo -e "✅ ${GREEN}Status individuel${NC} : État de chaque conteneur DevOps affiché séparément"
        echo -e "✅ ${GREEN}Métriques qui changent${NC} : Les valeurs évoluent en temps réel"
        echo -e "✅ ${GREEN}Pas de valeurs identiques${NC} : Chaque conteneur DevOps a ses propres métriques"
        echo -e "✅ ${GREEN}Filtrage DevOps${NC} : Affiche seulement les conteneurs du projet DevOps"
        ...
        echo "   ./devops-filtered-dashboard.sh --continuous"
        sleep 5
    done
else
    echo -e "${CYAN}🚀 DevOps Project - Monitoring Final (DevOps Containers Only)${NC}"
    ...
    echo "=========================="
    echo "✅ 'DevOps Project - Monitoring Final (DevOps Containers Only)' - MÉTRIQUES DEVOPS UNIQUEMENT"
    echo "   - URL: http://localhost:3000/d/c07a6041-d4d5-4d10-9a4b-a878498c7c43/5a3656b"
    echo "   - Métriques DevOps uniquement (seulement les conteneurs DevOps)"
    ...
    echo "   - Filtrage DevOps : Affiche seulement les conteneurs du projet DevOps"
    ...
    echo ""
    echo -e "${GREEN}✅ Dashboard DevOps Containers Only ouvert !${NC}"
    echo "   - Métriques DevOps uniquement (seulement les conteneurs DevOps)"
    echo "   - 4 conteneurs DevOps spécifiques : Portainer, MongoDB, Backend, Frontend"
    echo "   - Métriques individuelles qui changent en temps réel"
    echo "   - Graphiques CPU et Memory qui évoluent"
