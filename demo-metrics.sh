...
echo "🚀 Démonstration des métriques DevOps Project"
echo "============================================="
echo ""
...
show_container_metrics() {
    ...
    echo "📊 Métriques pour $container_name ($container_id):"
...
echo "   - Sélectionner le dashboard 'DevOps Project - Conteneurs Non-Optimisés (Live)'"
