...
show_all_containers_in_graphs() {
    echo -e "${WHITE}🚀 DevOps Project - Monitoring Final (Tous les Conteneurs dans les Graphiques)${NC}"
    echo -e "${WHITE}=======================================================================${NC}"
    echo ""
    ...
    echo ""
    echo -e "${GREEN}✅ Tous les conteneurs affichés dans les deux graphiques avec couleurs distinctes${NC}"
}
