...
# Fonction pour afficher les vraies métriques des conteneurs
show_real_metrics() {
    echo -e "${WHITE}🚀 DevOps Project - Monitoring Final (Métriques Réelles)${NC}"
    echo -e "${WHITE}=====================================================${NC}"
    echo ""
    
    # Collecter les vraies métriques de tous les conteneurs
    ...
    echo ""
    echo -e "${GREEN}✅ Vraies métriques des conteneurs affichées (pas de 13.5577% identique)${NC}"
}
