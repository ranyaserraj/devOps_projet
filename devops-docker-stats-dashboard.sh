...
main() {
    clear
    echo -e "${WHITE}🚀 DevOps Project - Monitoring Final (Docker Stats)${NC}"
    echo -e "${WHITE}===============================================${NC}"
    echo ""
    ...
    echo ""
    echo -e "${YELLOW}💡 Pour une surveillance continue avec Docker Stats, utilisez:${NC}"
    echo -e "${WHITE}   ./devops-docker-stats-dashboard.sh --continuous${NC}"
    echo ""
    echo -e "${GREEN}✅ Monitoring Docker Stats actif - Chaque conteneur affiché individuellement${NC}"
}
