...
echo "🚀 DevOps Project - Monitoring Final (Un Seul Graphique)"
echo "======================================================="
echo ""
...
# Afficher tous les conteneurs dans un seul graphique
echo "📈 Tous les conteneurs dans un seul graphique:"
echo "============================================="

# Fonction pour afficher tous les conteneurs dans un seul graphique
show_single_graph() {
    ...
    # Afficher le graphique CPU avec tous les conteneurs dans un seul graphique
    ...
    # Afficher le graphique Memory avec tous les conteneurs dans un seul graphique
...
echo "=========================="
echo "1. 'DevOps Project - Monitoring Final' (Un Seul Graphique)"
echo "2. 'DevOps Project - Monitoring Final' (Tous les Conteneurs dans les Graphiques)"
echo "3. 'DevOps Project - Monitoring Final' (Métriques Groupées)"
echo "4. 'DevOps Project - Conteneurs Individuels (Docker Stats)'"
echo "5. 'DevOps Project - Conteneurs Individuels'"
echo "6. 'DevOps Project - Métriques Système'"
echo ""

echo "💡 Pour une surveillance continue avec un seul graphique:"
echo "   ./devops-single-graph-dashboard.sh --continuous"
echo ""
...
echo ""
echo "✅ Dashboard avec un seul graphique ouvert !"
echo "   - CPU Usage : Tous les conteneurs dans un seul graphique avec Docker Stats"
echo "   - Memory Usage : Tous les conteneurs dans un seul graphique avec Docker Stats"
echo "   - Pas de formule Prometheus, utilisation directe de Docker Stats"
