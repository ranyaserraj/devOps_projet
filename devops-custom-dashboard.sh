...
show_custom_dashboard() {
    echo -e "${WHITE}🚀 DevOps Project - Monitoring Final (Dashboard Personnalisé)${NC}"
    echo -e "${WHITE}=============================================================${NC}"
    echo ""
    ...
    echo ""
    echo -e "${GREEN}✅ Dashboard personnalisé avec vraies métriques (pas de 14.5579% identique)${NC}"
}
