...
echo "🚀 DevOps Project - Monitoring Final (Individuel)"
echo "================================================"
echo ""
...
# Afficher les métriques individuelles de chaque conteneur
...
echo "=========================="
echo "1. 'DevOps Project - Monitoring Final' (Individuel)"
echo "2. 'DevOps Project - Métriques Système'"
echo "3. 'DevOps Project - Conteneurs Non-Optimisés (Live)'"
echo ""

echo "💡 Pour une surveillance continue individuelle:"
echo "   ./devops-individual-final-dashboard.sh --continuous"
echo ""
