...
show_single_graph() {
    echo -e "${WHITE}🚀 DevOps Project - Monitoring Final (Un Seul Graphique)${NC}"
    echo -e "${WHITE}=====================================================${NC}"
    echo ""
    ...
    echo ""
    echo -e "${GREEN}✅ Tous les conteneurs affichés dans un seul graphique avec Docker Stats${NC}"
}
